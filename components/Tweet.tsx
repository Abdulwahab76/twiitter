...
interface Props {
  tweet: Tweet;
  // timer:boolean;
  postDelete:(id:any,show:boolean)=>void;
}
const TweetComponent = ({ tweet,postDelete }: Props) => {
    ...
    <div className="hover:bg-gray-50 flex flex-col space-x-1 border-y mt-2 p-5 border-gray-300">
      {undoButton ? (
        <div className="flex justify-around items-center">
          <p>If you want to back this post.</p>
          <button
            className="border text-black text-sm px-2  bg-gray-300 p-1"
            onClick={backUndo}
          >
            Undo
          </button>
